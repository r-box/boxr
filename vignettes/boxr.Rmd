...
#### 1. 'Create an app'
At [https://app.box.com/developers/services](https://app.box.com/developers/services)^[This URL returns a 403 HTTP status code, and then presents you with a login screen. This behavior is frowned upon by the CRAN URL checks, but is neccesary to use the package.], log in and create a new 'app' for your box.com account. You can call it anything you like. This won't do anything remotely like creating an app, but it does allow you to access your account via the API.
