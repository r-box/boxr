...
![Create: four steps](figures/service-four-steps.png){width=100%}
...
![Config - Step 1](figures/service-config-1.png){width=100%}

![Config - Step 2](figures/service-config-2.png){width=100%}
...
![Config - Step 3](figures/service-config-3.png){width=100%}

### Authorize App

The last step is to authorize your app - this has to be done by someone on your Box-admin team. If this is a personal account, that's you. Go to https://app.box.com/master/settings/openbox :
...
![Authorize](figures/service-authorize.png){width=100%}