...
manfig <- function(x) {
  system.file(glue::glue("help/figures/{x}"), package = "boxr")
}
```
...
![Upload to RStudio Server/Cloud](`r manfig("rstudio_cloud.png")`){width=100%}
...
<!-- ![Create: four steps](figures/interactive-four-steps.png){width=100%} -->
...
<!-- ![Configure](figures/interactive-config.png){width=100%} -->
