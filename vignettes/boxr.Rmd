...
Functions that operate on Box files or directories (folders) have arguments: `file_id` or `dir_id`. You can use the [box.com](https://box.com) web interface to find these values. Although they look like numbers, it is useful to think of them as character strings.
