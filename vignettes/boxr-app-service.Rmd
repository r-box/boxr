...
2. The `dir_id` of the folder you want to share.

3. The `account_id` of the account you are inviting.

4. The `role` (permissions) you would like the collaborator to have. 
